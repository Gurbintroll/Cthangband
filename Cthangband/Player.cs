...
namespace Cthangband
{
    ...
    internal class Player
    {
        ...
        public bool SetTimedBlindness(int v)
        {
            ...
            SaveGame.Instance.Disturb(false);
            UpdateFlags |= Constants.PuUnView | Constants.PuUnLight;
            UpdateFlags |= Constants.PuView | Constants.PuLight;
            UpdateFlags |= Constants.PuMonsters;
