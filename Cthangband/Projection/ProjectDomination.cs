...
{
    internal class ProjectDomination : BaseProjection
    {
        public ProjectDomination(SpellEffectsHandler spellEffectsHandler) : base(spellEffectsHandler)
        {
            BoltGraphic = "";
            ImpactGraphic = "";
        ...
        protected override bool AffectMonster(int who, int r, int y, int x, int dam)
        {
            ...
            {
                var getAngry = (rPtr.Flags3 & MonsterFlag3.ImmuneConfusion) == 0;
                if (getAngry && who == 0)
                {
