...
{
    internal class ProjectOldClone : BaseProjection
    {
        public ProjectOldClone(SpellEffectsHandler spellEffectsHandler) : base(spellEffectsHandler)
        {
        ...
        protected override bool AffectMonster(int who, int r, int y, int x, int dam)
        {
            ...
            {
                var getAngry = Program.Rng.DieRoll(8) == 1;
                if (getAngry && who == 0)
                {
