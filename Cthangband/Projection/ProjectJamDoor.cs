...
{
    internal class ProjectJamDoor : BaseProjection
    {
        public ProjectJamDoor(SpellEffectsHandler spellEffectsHandler) : base(spellEffectsHandler)
        {
            BoltGraphic = "";
            ImpactGraphic = "";
        ...
        protected override bool AffectFloor(int y, int x)
        {
            ...
            if (cPtr.FeatureType.IsClosedDoor)
            {
                ...
                var strength = int.Parse(cPtr.FeatureType.Name.Substring(10));
                if (strength < 7)
                {
