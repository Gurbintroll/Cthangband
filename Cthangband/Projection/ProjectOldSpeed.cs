...
{
    internal class ProjectOldSpeed : BaseProjection
    {
        public ProjectOldSpeed(SpellEffectsHandler spellEffectsHandler) : base(spellEffectsHandler)
        {
