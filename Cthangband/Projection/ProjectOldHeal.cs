...
{
    internal class ProjectOldHeal : BaseProjection
    {
        public ProjectOldHeal(SpellEffectsHandler spellEffectsHandler) : base(spellEffectsHandler)
        {
