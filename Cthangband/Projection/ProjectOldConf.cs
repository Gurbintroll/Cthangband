...
{
    internal class ProjectOldConf : BaseProjection
    {
        public ProjectOldConf(SpellEffectsHandler spellEffectsHandler) : base(spellEffectsHandler)
        {
        ...
        protected override bool AffectMonster(int who, int r, int y, int x, int dam)
        {
            ...
            var doConf = Program.Rng.DiceRoll(3, dam / 2) + 1;
