...
{
    internal class ProjectLight : BaseProjection
    {
        public ProjectLight(SpellEffectsHandler spellEffectsHandler) : base(spellEffectsHandler)
        {
        ...
        protected override bool AffectMonster(int who, int r, int y, int x, int dam)
        {
            ...
            {
                var getAngry = (rPtr.Flags3 & MonsterFlag3.HurtByLight) != 0;
                if (getAngry && who == 0)
                {
